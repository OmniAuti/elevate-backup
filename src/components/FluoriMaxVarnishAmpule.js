...
export default class FluoriMaxVarnishAmpule extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return (
      <section >
        <ProductAside/>
        <div className="FMV-ampule-cont">
        <h1>FluoriMax™ Varnish - Flow-Through Unit-Dose Ampule - Bubble Gum</h1>
        <img
